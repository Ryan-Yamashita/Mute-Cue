...
Assert-AccessibilityRuntime ($component.AssemblyVersion -eq "0.5.1.0" -and $component.ContractVersion -eq 1) "The accessibility component identity is unexpected."
